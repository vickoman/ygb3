    ...
    <?php
        ...
        <?php }
            ...
            <div id="rtm-gallery-title-container" class="row">
               <h2 class="rtm-gallery-title columns large-3 small-12 medium-3" style="width:35%">
                    <?php if( $title ) { echo $title; }
                            else { _e( 'Media Gallery', 'rtmedia' ); } ?>
                </h2>
                <div id="rtm-media-options" class="columns large-9 small-12 medium-9"  style="width:65%"><?php do_action ( 'rtmedia_media_gallery_actions' ); ?></div>
            </div>
			<div class="clear"></div>
