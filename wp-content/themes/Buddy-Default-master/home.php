	...
	<div class="widget">
		<div class="widget-body padding-none margin-none">
			...
			<div id="clearybih7" style="clear: both; height: 0px; width: 0px; display: block;"></div><div class="galcolumn" id="item0mNtW2" style="width: 49.37823834196891%; padding-left: 12px; padding-bottom: 12px; float: left; box-sizing: border-box;"><div class="widget gridalicious-item not-responsive" style="margin-bottom: 12px; zoom: 1; opacity: 1;">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/photodune-2755655-party-time-s.jpg" alt="" class="img-responsive" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;">
						...
						<div class="border-top innerAll">
							<div class="pull-left">
								...
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/people/35/13.jpg" class="img-circle pull-left innerR half" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/people/35/10.jpg" class="img-circle pull-left innerR half" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/people/35/18.jpg" class="img-circle pull-left innerR half" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/people/35/1.jpg" class="img-circle pull-left innerR half" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/people/35/23.jpg" class="img-circle pull-left innerR half" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;">
							</div>
							<div class="pull-right">
								...
								<a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/people/35/13.jpg" class="img-circle pull-right" data-toggle="tooltip" fata-placement="top" data-title="Marie" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;"></a>
							</div>
						</div>
						...
						<a href=""><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/photodune-6374531-at-celebration-xs.jpg" alt="" class="img-responsive" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;"></a>
						<!-- Info -->
						<div class="bg-primary">
							<div class="innerAll">
						...
						<div class="media margin-none bg-gray">
							<a href="" class="pull-left innerAll">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/people/50/12.jpg" width="50" class="media-object" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;">
							</a>
						...
						<div id="weather-carousel" class="carousel slide innerAll" data-ride="carousel">
						  <!-- Wrapper for slides -->
							...
							<ol class="carousel-indicators">
							    <li data-target="#weather-carousel" data-slide-to="0" class=""></li>
							    <li data-target="#weather-carousel" data-slide-to="1" class=""></li>
						...
						<div class="media">
							<a href="" class="pull-left"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/people/50/3.jpg" width="50" class="media-object" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;"></a>
							<div class="media-body innerTB half">
					...
					</div></div><div class="galcolumn" id="item1mNtW2" style="width: 49.37823834196891%; padding-left: 12px; padding-bottom: 12px; float: left; box-sizing: border-box;"><div class="widget gridalicious-item not-responsive" style="margin-bottom: 12px; zoom: 1; opacity: 1;">

						<!-- Info -->
						<div class="bg-primary">
							<div class="media">
								<a href="" class="pull-left"><img src="../assets/images/people/50/13.jpg" width="50" class="media-object" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;"></a>
								<div class="media-body innerTB half">
								...
								<div class="col-md-6">
									...
									<div class="media margin-none">
										<a href="" class="pull-left ">
											<img src="data:image/png;base64," data-src="holder.js/50x50" class="media-object" alt="50x50" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;">
										</a>
										<div class="media-body">
						...
						<div class="collapse" id="comments-collapse">	
							...
							<!-- Second Comment -->
							<div class="media margin-none ">
								<a href="" class="pull-left innerAll"><img src="../assets/images/people/50/11.jpg" width="50" class="media-object" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;"></a>
								<div class="media-body innerTB">
						...
						<div class="innerAll">
							...
							<div class="innerB">
								<a href=""><img src="../assets/images/social/100/1.jpg" alt="" class="img-post display-block-inline" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;"></a>
								<a href=""><img src="../assets/images/social/100/2.jpg" alt="" class="img-post display-block-inline" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;"></a>
								<a href=""><img src="../assets/images/social/100/3.jpg" alt="" class="img-post display-block-inline" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;"></a>
							</div>
						</div>
						...
						<div class="media border-bottom margin-none bg-gray">
							<a href="" class="pull-left innerAll half">
								<img src="../assets//images/people/50/2.jpg" width="50" class="media-object" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;">
							</a>
							<div class="media-body innerTB">
								<a href="#" class="pull-right innerT innerR text-muted">
									<i class="icon-reply-all-fill fa fa-2x "></i>
						...
						<div class="media margin-none bg-gray">
							<a href="" class="pull-left innerAll half">
								<img src="../assets//images/people/50/11.jpg" width="50" class="media-object" style="width: auto; height: auto; display: block; margin-left: auto; margin-right: auto;">
							</a>
							<div class="media-body innerTB">
					...
					</div></div><div id="clearmNtW2" style="clear: both; height: 0px; width: 0px; display: block;"></div></div>
		...
		<div class="col-md-4 col-lg-3">
			...
			<div class="widget">
				<div class="widget-body text-center">
					...
					<h2 class="strong margin-none"><?php echo $bp->loggedin_user->fullname;?></h2>
					<!--  TAG DE LUGAR DE TRABAJO <div class="innerB">Working at MOSAICPRO</div> -->
					<!-- TIPO DE CARGO <a href="" class="btn btn-primary text-center btn-block">SP7</a> -->
					<div class="btn-group-vertical btn-block">
						<a href="" class="btn btn-default"><i class="fa fa-cog pull-right"></i>Editar Cuenta</a>
						<a href="<?php echo wp_logout_url( wp_guess_url() ); ?>" class="btn btn-default"><i class="fa fa-cog pull-right"></i>Salir de Yogobierno</a>
					</div>
				</div>
			</div>
